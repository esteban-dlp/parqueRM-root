...
CREATE TABLE IF NOT EXISTS visitor_records (
    ...
    has_medication_allergy INTEGER NOT NULL DEFAULT 0,
    medication_allergy_detail TEXT NULL,
    ...
    has_animal_bite_allergy INTEGER NOT NULL DEFAULT 0,
    animal_bite_allergy_detail TEXT NULL,
